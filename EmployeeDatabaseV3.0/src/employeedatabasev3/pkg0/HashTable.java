...
public class HashTable {
    ...
    public Object[] getTableInfo() {
        ...
        tableContent[0] = persons[0].get(0).getEmployeeNumber();
        tableContent[1] = persons[0].get(0).getFirstName();
        tableContent[2] = persons[0].get(0).getLastName();
        tableContent[3] = persons[0].get(0).getWorkLocation();
        tableContent[4] = persons[0].get(0).getEmployeeStatus();
